...
namespace ESG.IDMS.Application.Helpers
{
    public static class ReportDataHelper
    {
        public static async Task<LabelResultAndStyle> ConvertSQLQueryToJsonAsync(IAuthenticatedUser authenticatedUser, string connectionString, ReportState report, IList<ReportQueryFilterModel>? filters = null)
        {
            ...
            List<Dictionary<string, string>> tableColumnLabel = [];
            ...
            else
            {
                ...
                HashSet<string?> dataSetTitles = [];
                Dictionary<string, MultipleDataset> multipleDataSetList = [];
                Dictionary<string, Dataset> dataSetList = [];
                ...
                if (isMultipleResultSet)
                {
					...
					{
						ReportChartType.HorizontalBar => new LabelResultAndStyle()
						{
						...
						ReportChartType.Pie => new LabelResultAndStyle()
						{
