...
using ESG.IDMS.ExcelProcessor.CustomValidation;
using ESG.IDMS.ExcelProcessor.CustomTemplate;

namespace ESG.IDMS.ExcelProcessor.Services
{
        ...
        private async Task<Dictionary<string, object?>> CustomValidationPerRecordHandler(string module, Dictionary<string, object?> rowValue)
        {
            ...
            switch (module)
            {
                case nameof(FireArmsState):
					return await FireArmsValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(RadioEquipmentState):
					return await RadioEquipmentValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(VehicleState):
					return await VehicleValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(OtherEquipmentState):
					return await OtherEquipmentValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(FurnitureAndFixtureState):
					return await FurnitureAndFixtureValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(LocationState):
					return await LocationValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(StatusState):
					return await StatusValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(FireArmsBrandModelState):
					return await FireArmsBrandModelValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(RadioEquipmentBrandModelState):
					return await RadioEquipmentBrandModelValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(VehicleBrandModelState):
					return await VehicleBrandModelValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(OtherEquipmentBrandModelState):
					return await OtherEquipmentBrandModelValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(FurnitureAndFixtureBrandModelState):
					return await FurnitureAndFixtureBrandModelValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(RemarksState):
					return await RemarksValidator.ValidatePerRecordAsync(_context, rowValue);
