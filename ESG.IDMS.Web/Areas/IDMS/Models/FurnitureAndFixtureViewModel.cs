...
public record FurnitureAndFixtureViewModel : BaseViewModel
{	
	...
	[Display(Name = "Furniture and Fixture Brand / Model")]
	[Required]
	[StringLength(255, ErrorMessage = "{0} length can't be more than {1}.")]
	public string FurnitureAndFixtureBrandModelId { get; init; } = "";
	public string?  ReferenceFieldFurnitureAndFixtureBrandModelId { get; set; }
	...
	public FurnitureAndFixtureBrandModelViewModel? FurnitureAndFixtureBrandModel { get; init; }
