...
public record OtherEquipmentViewModel : BaseViewModel
{	
	...
	[Display(Name = "Other Equipment Brand / Model")]
	[Required]
	[StringLength(255, ErrorMessage = "{0} length can't be more than {1}.")]
	public string OtherEquipmentBrandModelId { get; init; } = "";
	public string?  ReferenceFieldOtherEquipmentBrandModelId { get; set; }
	...
	public OtherEquipmentBrandModelViewModel? OtherEquipmentBrandModel { get; init; }
