...
public record RadioEquipmentViewModel : BaseViewModel
{	
	...
	[Display(Name = "Radio Equipment Brand / Model")]
	[Required]
	[StringLength(255, ErrorMessage = "{0} length can't be more than {1}.")]
	public string RadioEquipmentBrandModelId { get; init; } = "";
	public string?  ReferenceFieldRadioEquipmentBrandModelId { get; set; }
	...
	public RadioEquipmentBrandModelViewModel? RadioEquipmentBrandModel { get; init; }
