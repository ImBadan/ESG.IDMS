...
public record VehicleViewModel : BaseViewModel
{	
	...
	[Display(Name = "Vehicle Brand / Model")]
	[Required]
	[StringLength(255, ErrorMessage = "{0} length can't be more than {1}.")]
	public string VehicleBrandModelId { get; init; } = "";
	public string?  ReferenceFieldVehicleBrandModelId { get; set; }
	...
	public VehicleBrandModelViewModel? VehicleBrandModel { get; init; }
