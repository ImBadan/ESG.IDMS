...
[Authorize(Policy = Permission.FurnitureAndFixture.History)]
public class HistoryModel : BasePageModel<HistoryModel>
{
    ...
    public async Task<IActionResult> OnGet(string? id)
    {
        ...
        _ = (await Mediatr.Send(new GetFurnitureAndFixtureByIdQuery(id))).Select(l=> Mapper.Map(l, FurnitureAndFixture));  
