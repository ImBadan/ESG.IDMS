...
[Authorize(Policy = Permission.RadioEquipmentBrandModel.History)]
public class HistoryModel : BasePageModel<HistoryModel>
{
    ...
    public async Task<IActionResult> OnGet(string? id)
    {
        ...
        _ = (await Mediatr.Send(new GetRadioEquipmentBrandModelByIdQuery(id))).Select(l=> Mapper.Map(l, RadioEquipmentBrandModel));  
