...
using ESG.IDMS.Web;
using ESG.IDMS.Web.Areas.Identity;
using ESG.IDMS.Web.Areas.Identity.Data;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Options;
using Microsoft.Net.Http.Headers;
using ESG.IDMS.EmailSending;
using ESG.IDMS.ExcelProcessor;
using ESG.Common.Services.Shared;
using ESG.IDMS.ChatGPT;
using Serilog;
using ESG.IDMS.Scheduler;
...
app.UseSecurityHeaders(policies =>
    policies.AddDefaultSecurityHeaders()
            .AddContentSecurityPolicy(builder =>
            {
				...
				builder.AddFontSrc().From([ "https://fonts.gstatic.com",
